...
**El Zen de Python** para encontrarlo es solo necesario ejecutar la siguiente linea de codigo:
```
import this
```
Output:
...
```
### Sets
Tipo de dato Conjunto, esta relacionado con la teoria de conjuntos, propiedades principales:
- Se pueden modificar.
